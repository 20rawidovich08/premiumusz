...
export const SupportChat = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 w-[calc(100vw-2rem)] max-w-sm rounded-2xl border border-border/60 bg-card/95 p-4 shadow-2xl backdrop-blur-xl md:bottom-6 md:right-6">
